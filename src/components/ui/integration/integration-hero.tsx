    ...
    <section className="max-w-[1280px] mx-auto lg:space-y-10 md:space-y-8 space-y-6 lg:mt-28 md:mt-16 mt-10">
      <div className="lg:px-0 md:px-0 px-[5%] lg:space-y-10 md:space-y-8 space-y-6">
        ...
        <div className="flex md:flex-row flex-col justify-center items-center gap-5">
          <a href="#" className="bg-[#00B0F4] text-center hover:no-underline text-white rounded-xl border border-[#2CC9FF] pt-[12px] pb-[12px] pr-[16px] pl-[16px] transition-all duration-500 hover:shadow-[0_0_0_2px_rgba(44,201,255,0.4)] hover:scale-[1.01] md:w-auto w-full">
            Start For free
          </a>
