    ...
    <section className="max-w-[1280px] mx-auto lg:space-y-16 md:space-y-8 space-y-6 lg:mt-28 md:mt-16 mt-10 px-[5%]">
      ...
      <div className="w-full">
        <div className="hidden lg:flex justify-center items-center">
          <Image src="/subscription-management/subscription-management-hero-lg.svg" alt="Subscription management hero" width={800} height={400} priority className="w-full h-full" />
        </div>
        <div className="lg:hidden md:flex hidden justify-center items-center">
          <Image src="/subscription-management/subscription-management-hero-md.svg" alt="Subscription management hero" width={600} height={300} className="w-full h-full" />
        </div>
        <div className="lg:hidden md:hidden w-full flex justify-center items-center">
          <Image src="/subscription-management/subscription-management-hero-sm.svg" alt="Subscription management hero" width={400} height={200} />
        </div>
      </div>
    </section>
  );
