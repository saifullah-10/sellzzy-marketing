...
const CreateOrders = () => {
    return (
        <section className="">
            <div className="max-w-[1280px] mx-auto lg:space-y-10 md:space-y-8 space-y-6 lg:mt-28 md:mt-16 mt-10 px-[5%]">
            ...
            <div>
                ...
                <div className="h-full w-full object-contain lg:hidden md:block hidden">
                    <Image src="/order-management/order-management-create-orders-md.svg" alt="Create orders" width={800} height={400} className="mx-auto" />
                </div>
